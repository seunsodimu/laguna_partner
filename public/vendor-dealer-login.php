<?php
/**
 * Vendor & Dealer Login Page
 * OTP-based authentication for Vendor and Dealer users
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action']) && $_POST['action'] === 'send_otp') {
        ...
        } elseif (empty($userType) || !in_array($userType, ['vendor', 'dealer'])) {
...
<head>
    ...
    <title>Vendor & Dealer Login - Laguna Partners Portal</title>
    ...
    <div class="container">
        <div class="login-card">
            <div class="login-header">
                ...
                <p class="mb-2">Vendor & Dealer Access</p>
                <div>
                    <span class="user-type-badge badge-vendor"><i class="bi bi-building"></i> Vendor</span>
                    <span class="user-type-badge badge-dealer"><i class="bi bi-shop"></i> Dealer</span>
                </div>
            </div>
            <div class="login-body">
                ...
                <?php if ($step === 'email'): ?>
                    ...
                    <div class="portal-link">
                        <small class="text-muted">Are you an Admin or Buyer?</small><br>
                        <a href="admin-buyer-login.php" class="btn btn-outline-secondary btn-sm mt-2">
                            <i class="bi bi-arrow-left"></i> Go to Admin/Buyer Login
                        </a>
                    </div>
                <?php else: ?>
                    <!-- Step 2: Enter OTP -->
                    <div class="text-center mb-4">
                        <i class="bi bi-envelope-check" style="font-size: 3rem; color: #134e5e;"></i>
                    ...
                    <form method="POST" action="">
                        ...
                        <a href="<?php echo BASE_PATH; ?>/vendor-dealer-login.php" class="btn btn-outline-secondary w-100">
